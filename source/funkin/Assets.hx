...
class Assets
{
   ...
   */
  public static function getBitmapData(path:String, ?pushToGpu:Bool = true):openfl.display.BitmapData
  {
    return openfl.utils.Assets.getBitmapData(path, true, true, pushToGpu);
  }
   ...
   */
  public static function loadBitmapData(path:String, ?pushToGpu:Bool = true):Future<openfl.display.BitmapData>
  {
    return openfl.utils.Assets.loadBitmapData(path, true, pushToGpu);
  }
